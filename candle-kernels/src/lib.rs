...
pub const FUSED_NORM_SCALE_SHIFT: &str = include_str!(concat!(env!("OUT_DIR"), "/fused_norm_scale_shift.ptx"));
pub const FUSED_QKV_ATTENTION: &str = include_str!(concat!(env!("OUT_DIR"), "/fused_qkv_attention.ptx"));
